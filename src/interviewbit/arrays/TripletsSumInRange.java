...
public class TripletsSumInRange {
		...
		public int solve(ArrayList<String> A) {
	        ...
	        while(startIndex<middleIndex && middleIndex<endIndex) {
	            sum = Double.parseDouble(A.get(startIndex)) + Double.parseDouble(A.get(middleIndex)) + Double.parseDouble(A.get(endIndex));
	            if(sum>=2) {
	...
	public static void main(String[] args) {
		...
		int result = tpr.solve(new ArrayList<String>(Arrays.asList("0.6", "0.7", "0.8", "1.2", "0.4")));
